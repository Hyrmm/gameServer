export class EventManager {
    ...
    static events: Map<string, Subscription[]> = new Map()
    static onceEvents: Map<string, Subscription[]> = new Map()
     ...
     * @param target 目标
     */
    static on(name: string, callback: Function, target?: any) {
     ...
     * @param target 目标
     */
    static once(name: string, callback: Function, target?: any) {
     ...
     * @param target 目标
     */
    static off(name: string, callback: Function, target?: any) {
        // 普通事件
     ...
     * @param inTarget 目标
     */
    static compare(subscription: Subscription, inCallback: Function, inTarget: any) {
